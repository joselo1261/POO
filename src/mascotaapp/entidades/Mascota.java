...
public class Mascota {
    ...
    public Mascota() {
        this.energia=1000;  // asignamos esto 
    }
    ...
    public int pasear(int energiaRestar){
     ...
     // energia-= energiaRestar; <= es lo mismo que la linea anterior
        return energia;
    }
    
    /**
     * Funcion destinada a pasear con vueltas
     * 
     * @param energiaRestar
     * @param vueltas
     * @return energia
     */
    // Sobrecarga de Metodo de Operacion
